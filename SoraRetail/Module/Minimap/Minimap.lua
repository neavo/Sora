...
local function SetMouseClick()
    ...
    local list = {
        ...
        {text = SPELLBOOK_ABILITIES_BUTTON, func = function()SpellbookMicroButton:Click() end},
        {text = TALENTS_BUTTON, func = function()TalentMicroButton:Click() end},
        {text = ACHIEVEMENT_BUTTON, func = function()AchievementMicroButton:Click() end},
        {text = QUESTLOG_BUTTON, func = function()QuestLogMicroButton:Click() end},
        {text = GUILD, func = function()GuildMicroButton:Click() end},
        {text = LFG_TITLE, func = function()LFDMicroButton:Click() end},
        {text = MOUNTS_AND_PETS, func = function()CollectionsMicroButton:Click() end},
        {text = ENCOUNTER_JOURNAL, func = function()EJMicroButton:Click() end},
