...
local function GetItemLevelFrame(self, category)
    if (not self.ItemLevelFrame) then
        ...
        self.ItemLevelFrame.slotString:SetFont(STANDARD_TEXT_FONT, 12, "OUTLINE")
        ...
        self.ItemLevelFrame.slotString:SetShadowOffset(1, -1)
        self.ItemLevelFrame.slotString:SetShadowColor(0, 0, 0, 0.5)
        ...
        self.ItemLevelFrame.levelString:SetShadowOffset(1, -1)
        self.ItemLevelFrame.levelString:SetShadowColor(0, 0, 0, 0.5)
